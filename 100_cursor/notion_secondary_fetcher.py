#!/usr/bin/env python3
"""
Secondaryアカウント用のNotionコンテンツ取得スクリプト
"""
import os
import json
import sys
...
BATCH_SIZE = 20
STATE_FILE = "/Users/hashiguchimasaki/project/obsidian/100_cursor/.secondary_fetch_state.json"
...
def main():
    """メイン処理"""
    print("=" * 60)
    print("Notion Secondary Account Content Fetcher")
    print("=" * 60)
